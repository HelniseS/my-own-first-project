...
Wireframes for this portfolio website were designed using **Balsamiq** following a **mobile-first approach**. 
The mobile layout was created first to prioritise essential content and usability on smaller screens, followed by tablet and desktop versions.

The wireframes were used to plan navigation placement, content hierarchy, and layout structure before development began. 
Minor deviations from the original designs were made during implementation to improve spacing, accessibility, and visual clarity; however, the overall structure and intentions of the wireframes were maintained throughout the project.
...
|-----------|--------------|--------|
| Quickly understand who the developer is | Home & About sections | Pass |
| View education and skills | About section | Pass |
| Identify tools used | Technologies section | Pass |
| Find contact information easily | Contact section | Pass |
| Download CV | Download button | Pass |
...
All HTML and CSS code in this project was written by me unless explicitly stated otherwise.  
The design, layout decisions, and content structure are my own work and were created for this portfolio project.

Any third-party resources have been credited below in accordance with best practice and open-source licensing.
...
All third-party materials were used in accordance with their respective licenses.
